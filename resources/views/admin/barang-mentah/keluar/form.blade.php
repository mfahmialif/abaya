...
<div class="col-sm-12">
    ...
    <div class="input-group input-group-merge">
        <input type="number" class="form-control" name="jumlah" placeholder="Jumlah" aria-label="Type here..."
            aria-describedby="jumlah2" disabled required />
    </div>
</div>
<div class="col-sm-12">
    ...
    <div class="input-group input-group-merge">
        <input type="date" class="form-control" name="tanggal" placeholder="Tanggal" aria-label="Type here..."
            aria-describedby="tanggal2" disabled required />
    </div>
</div>
<div class="col-sm-12">
    <label class="form-label" for="keterangan">Keterangan</label>
    <div class="input-group input-group-merge">
        <textarea class="form-control" disabled name="keterangan" placeholder="Isi keterangan / bisa dikosongi..."
