...
@section('title', 'Barang Mentah Keluar')
@section('content')

    @include('admin.barang-mentah.keluar.filter')
    ...
    @include('admin.barang-mentah.keluar.add')
    @include('admin.barang-mentah.keluar.edit')
        ...
        $(document).on('submit', '.form-delete-record', function(e) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    $.ajax({
                        type: "POST",
                        url: "{{ route('admin.barang-mentah.keluar.delete') }}",
