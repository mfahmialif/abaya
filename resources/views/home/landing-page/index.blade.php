            ...
            <div class="container">
                ...
                <div class="features-icon-wrapper row gx-0 gy-6 g-sm-12">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/laptop.png" alt="laptop charging" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/rocket.png" alt="transition up" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/paper.png" alt="edit" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/check.png" alt="3d select solid" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/user.png" alt="lifebelt" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-4">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/keyboard.png" alt="google docs" />
                        </div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-1.png"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-2.png"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-3.png"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-4.png"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-3 avatar-sm">
                                                        <img src="{{ asset('admin') }}/assets/img/avatars/4.png"
                                                            alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-5.png"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                    “I've never used a theme as versatile and flexible as Vuexy. It's my go
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-4">
                                                    <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo-6.png"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
            ...
            <div class="container">
                <div class="swiper-logo-carousel py-8">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset('admin') }}/assets/img/front-pages/branding/logo_1-light.png"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/team-member-1.png"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/team-member-2.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/team-member-3.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div
                                ...
                                <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/team-member-4.png"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                ...
                <div class="text-center mb-12">
                    <div class="position-relative d-inline-block pt-3 pt-md-0">
                        ...
                        <div class="pricing-plans-item position-absolute d-flex">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/icons/pricing-plans-arrow.png"
                ...
                <div class="row g-6 pt-lg-5">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset('admin') }}/assets/img/front-pages/icons/paper-airplane.png"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card border border-primary shadow-xl">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset('admin') }}/assets/img/front-pages/icons/plane.png"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset('admin') }}/assets/img/front-pages/icons/shuttle-rocket.png"
                ...
                <div class="row gy-6">
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-primary shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('admin') }}/assets/img/front-pages/icons/laptop.png" alt="laptop"
                                    class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-success shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('admin') }}/assets/img/front-pages/icons/user-success.png"
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-info shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('admin') }}/assets/img/front-pages/icons/diamond-info.png"
                                    alt="laptop" class="mb-4" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset('admin') }}/assets/img/front-pages/icons/check-warning.png"
                                    alt="laptop" class="mb-4" />
        ...
        <section id="landingFAQ" class="section-py bg-body landing-faq">
            <div class="container">
                ...
                <div class="row gy-12 align-items-center">
                    <div class="col-lg-5">
                        <div class="text-center">
                            <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/faq-boy-with-logos.png"
            ...
            <div class="container">
                <div class="row align-items-center gy-12">
                    ...
                    <div class="col-lg-6 pt-lg-12 text-center text-lg-end">
                        <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/cta-dashboard.png"
                ...
                <div class="row g-6">
                    <div class="col-lg-5">
                        <div class="contact-img-box position-relative border p-2 h-100">
                            ...
                            <img src="{{ asset('admin') }}/assets/img/front-pages/landing-page/contact-customer-service.png"
